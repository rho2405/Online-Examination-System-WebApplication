...
if (!isset($_SESSION['cnt2'])) {
    ...
    $_SESSION['q_paper2'] = $question_paper;
    ...
    $question_paper = $_SESSION['q_paper2'];
    $q = $question_paper["q"];
    $qn = $question_paper["qn"];
    $choice1 = $question_paper["choice1"];
    $choice2 = $question_paper["choice2"];
...
function data_read() {
    ...
    $row = 1;
    if (($handle = fopen("text2.csv", "r")) !== FALSE) {
...
if (isset($_POST['submit'])) {
    ...
    $sql="UPDATE answer_table SET marks2=".$marks.",attempt2=".$attempt." WHERE username='".$username."'";
    ...
    $_SESSION['end_time']=$end_time;
     header('Location: http://'.$_SERVER['HTTP_HOST'].'/project/example3.php', true, 301);
     exit();
