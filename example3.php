...
if (!isset($_SESSION['cnt3'])) {
    ...
    $_SESSION['q_paper3'] = $question_paper;
    ...
    $question_paper = $_SESSION['q_paper3'];
    $q = $question_paper["q"];
    $qn = $question_paper["qn"];
    $choice1 = $question_paper["choice1"];
    $choice2 = $question_paper["choice2"];
...
function data_read() {
    ...
    $row = 1;
    if (($handle = fopen("text3.csv", "r")) !== FALSE) {
...
if (isset($_POST['submit'])) {
    ...
    $sql="UPDATE answer_table SET marks3=".$marks.",attempt3=".$attempt." WHERE username='".$username."'";
    ...
    mysqli_close($conn);
     ...
     header('Location: http://'.$_SERVER['HTTP_HOST'].'/project/result.php', true, 301);
     exit();
